...
CONTAINER_NAME="moonhub-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.moonhub/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run moonhub:"
echo "  cd packages/moonhub && go run ./cmd/moonhub gateway"
echo ""
