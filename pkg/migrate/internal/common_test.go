...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.moonhub")
	assert.Equal(t, "/home/user/.moonhub/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.moonhub/workspace/file.txt", "/home/user/.moonhub")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".moonhub"), result)
}
