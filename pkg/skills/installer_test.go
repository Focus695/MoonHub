...
func TestParseGitHubRef(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			repo:         "sipeed/moonhub",
			wantOwner:    "sipeed",
			wantRepoName: "moonhub",
			wantRef:      "main",
			wantSubPath:  "",
		},
		{
			name:         "owner/repo with subpath",
			repo:         "sipeed/moonhub/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "moonhub",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/sipeed/moonhub/tree/dev/skills/test",
			wantOwner:    "sipeed",
			wantRepoName: "moonhub",
			wantRef:      "dev",
			wantSubPath:  "skills/test",
		},
		{
			...
			repo:         "https://github.com/sipeed/moonhub/blob/main/README.md",
			wantOwner:    "sipeed",
			wantRepoName: "moonhub",
			wantRef:      "main",
		...
		},
		{
			...
			repo:         "https://github.com/sipeed/moonhub",
			wantOwner:    "sipeed",
			wantRepoName: "moonhub",
			wantRef:      "main",
			wantSubPath:  "",
...
func TestSkillInstaller_InstallFromGitHub_SkillAlreadyExists(t *testing.T) {
	...
	existingSkill := filepath.Join(skillsDir, "moonhub")
	...
	err = installer.InstallFromGitHub(context.Background(), "sipeed/moonhub")
	if err == nil {
