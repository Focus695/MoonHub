...
Examples:
  moonhub model                    # Show current default model
  moonhub model gpt-5.2           # Set gpt-5.2 as default
  moonhub model claude-sonnet-4.6 # Set claude-sonnet-4.6 as default
  moonhub model local-model       # Set local VLLM server as default
